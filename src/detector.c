...
void test_detector_simple(char *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh, float hier_thresh)
{
    list *options = read_data_cfg(datacfg);
    char *name_list = option_find_str(options, "names", "data/names.list");
    char **names = get_labels(name_list);
    ...
    while(1){
        ...
        print_detections(im, l.w*l.h*l.n, thresh, boxes, probs, names, alphabet, l.classes);
...
void run_detector(int argc, char **argv)
{
    ...
    else if(0==strcmp(argv[2], "test2")) test_detector_simple(datacfg, cfg, weights, filename, thresh, hier_thresh);

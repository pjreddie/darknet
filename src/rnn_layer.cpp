...
layer
make_rnn_layer(int batch, int inputs, int outputs, int steps, ACTIVATION activation, int batch_normalize, int adam) {
...
#ifdef CUDNN
    hipdnnSetTensor4dDescriptor(l.input_layer->dstTensorDesc, HIPDNN_TENSOR_NCHW, HIPDNN_DATA_FLOAT, batch, l.input_layer->out_c, l.input_layer->out_h, l.input_layer->out_w); 
    hipdnnSetTensor4dDescriptor(l.self_layer->dstTensorDesc, HIPDNN_TENSOR_NCHW, HIPDNN_DATA_FLOAT, batch, l.self_layer->out_c, l.self_layer->out_h, l.self_layer->out_w); 
    hipdnnSetTensor4dDescriptor(l.output_layer->dstTensorDesc, HIPDNN_TENSOR_NCHW, HIPDNN_DATA_FLOAT, batch, l.output_layer->out_c, l.output_layer->out_h, l.output_layer->out_w); 
#endif
#endif

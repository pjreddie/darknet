...
#ifdef CUDNN
        hipdnnSetTensor4dDescriptor(l.wf->dstTensorDesc, HIPDNN_TENSOR_NCHW, HIPDNN_DATA_FLOAT, batch, l.wf->out_c, l.wf->out_h, l.wf->out_w); 
        hipdnnSetTensor4dDescriptor(l.wi->dstTensorDesc, HIPDNN_TENSOR_NCHW, HIPDNN_DATA_FLOAT, batch, l.wi->out_c, l.wi->out_h, l.wi->out_w); 
        hipdnnSetTensor4dDescriptor(l.wg->dstTensorDesc, HIPDNN_TENSOR_NCHW, HIPDNN_DATA_FLOAT, batch, l.wg->out_c, l.wg->out_h, l.wg->out_w); 
        hipdnnSetTensor4dDescriptor(l.wo->dstTensorDesc, HIPDNN_TENSOR_NCHW, HIPDNN_DATA_FLOAT, batch, l.wo->out_c, l.wo->out_h, l.wo->out_w); 

        hipdnnSetTensor4dDescriptor(l.uf->dstTensorDesc, HIPDNN_TENSOR_NCHW, HIPDNN_DATA_FLOAT, batch, l.uf->out_c, l.uf->out_h, l.uf->out_w); 
        hipdnnSetTensor4dDescriptor(l.ui->dstTensorDesc, HIPDNN_TENSOR_NCHW, HIPDNN_DATA_FLOAT, batch, l.ui->out_c, l.ui->out_h, l.ui->out_w); 
        hipdnnSetTensor4dDescriptor(l.ug->dstTensorDesc, HIPDNN_TENSOR_NCHW, HIPDNN_DATA_FLOAT, batch, l.ug->out_c, l.ug->out_h, l.ug->out_w); 
        hipdnnSetTensor4dDescriptor(l.uo->dstTensorDesc, HIPDNN_TENSOR_NCHW, HIPDNN_DATA_FLOAT, batch, l.uo->out_c, l.uo->out_h, l.uo->out_w); 
#endif

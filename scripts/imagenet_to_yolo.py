...
classes = ['apple','backpack','ball','banana','baseball','basketball','bench','bicycle','bird','book',
           'bookshelf','bottle','bowl','broccoli','butterfly','car','carrot','cell phone','chair','chime',
           'clock','coffee maker','computer keyboard','computer mouse','crutch','cucumber','cup','dog',
           'door','drum','dumbbell','hair dryer','hamburger','hammer','handbag','head cabbage','helmet',
           'hotdog','key','lamp','laptop','lemon','microphone','orange','pencil box','person','pineapple',
           'ping-pong ball','pizza','pomegranate','pottedplant','power drill','printer','racket',
           'refrigerator','remote control','screwdriver','soccer ball','sofa','strawberry','sunglasses',
           'table','television','tennis ball','tie','umbrella','vase','volleyball','window']
